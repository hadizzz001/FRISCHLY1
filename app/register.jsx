...
const [zipCode, setZipCode] = useState('');
  ...
  // Dark mode colors
  // -------------------------
  const inputBg = colorScheme === 'dark' ? '#1f2937' : '#fff';
  const inputText = colorScheme === 'dark' ? '#fff' : '#000';
    ...
    >
      ...
      <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={{ paddingBottom: 50 }}>
        ...
        <View style={{ paddingHorizontal: 24, marginTop: 20 }}>
          <InputBox placeholder="Full Name" value={name} onChangeText={setName} inputBg={inputBg} inputText={inputText} placeholderColor={placeholderColor} />
          ...
          >
            {countryData && (
              <>
                <Image source={{ uri: countryData.flag }} style={{ width: 24, height: 18 }} />
          ...
          <InputBox placeholder="Email" value={email} onChangeText={setEmail} keyboardType="email-address" inputBg={inputBg} inputText={inputText} placeholderColor={placeholderColor} />
          ...
          >
            ...
            <TouchableOpacity onPress={() => setShowPassword(!showPassword)} style={{ paddingHorizontal: 10 }}>
              <Ionicons name={showPassword ? 'eye-off' : 'eye'} size={22} color={placeholderColor} />
            </TouchableOpacity>
          </View>
...
<View style={{ alignItems: 'center', marginTop: 10, marginBottom: 200 }}>
  <TouchableOpacity onPress={() => router.push('/start')}>
    <Text style={{ color: '#000', fontSize: 16 }}>Already have an account? Login</Text>
  </TouchableOpacity>
</View>
